...
- Publish the combined filter and manhwa reader update as extension version `0.2.9`.
...
- All three bundled sources use version `0.2.9` because they share one source file.
...
**Interfaces:**
- The patched client consumes the published `0.2.9` source.
