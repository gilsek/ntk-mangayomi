...
`NTK Novel` 0.303 is the independent Legacy rebuild. Popular shows all works
...
complete chapter lists are loaded from one Legacy detail response. The text
reader will be added in a later stage; the old
